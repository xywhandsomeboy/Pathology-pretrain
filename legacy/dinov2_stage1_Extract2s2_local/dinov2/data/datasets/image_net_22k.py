...
class ImageNet22k(ExtendedVisionDataset):
    ...
    def get_image_data(self, index: int) -> bytes:
        ...
        start_offset, end_offset = entry["start_offset"]* 512, entry["end_offset"]* 512
        
        try:
            mapped_data = class_mmap[start_offset:end_offset]
            header = mapped_data[:512]
            filename = header[:100].rstrip(b"\x00").decode("utf-8")
